...
var $ = window.jQuery || (jquery__WEBPACK_IMPORTED_MODULE_0___default());
window.$ = window.jQuery = $;
$(function () {
  $(document).on('click', '[data-confirm]', function (event) {
    var message = $(this).data('confirm') || 'Segur que vols continuar?';
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var fullBtn = (_document$querySelect = document.querySelector('.glyphicon-fullscreen')) === null || _document$querySelect === void 0 ? void 0 : _document$querySelect.parentElement;
...
/******/ 	__webpack_require__.O(undefined, ["css/components/app"], () => (__webpack_require__("./resources/assets/js/ppIntranet.js")))
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["css/components/app"], () => (__webpack_require__("./resources/assets/sass/app.scss")))
