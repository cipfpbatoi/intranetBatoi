...
// js scottish gaelic two word and hyphenated months
...
Component.options.__file = "resources/assets/js/components/utils/ControlNav.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-04181adb", Component.options)
  } else {
    hotAPI.reload("data-v-04181adb", Component.options)
  }
...
Vue.component('example', __webpack_require__(141));
Vue.component('control-dia-view', __webpack_require__(144));
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(4), __webpack_require__(139).setImmediate))
...
/* harmony default export */ __webpack_exports__["default"] = ({
    props: ['espacios'],
    mounted: function mounted() {
        console.log('Component muy ready.');
          ...
          _c("div", { staticClass: "panel-body" }, [
            ...
            _c(
              ...
              [
                ...
                _vm._v(" "),
                _vm._l(_vm.espacios, function(espacio) {
                  return _c("option", { domProps: { value: espacio.aula } }, [
                    _vm._v(_vm._s(espacio.descripcion))
                  ])
                })
              ],
              2
...
Component.options.__file = "resources/assets/js/components/fichar/ControlDiaView.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-056b5e1a", Component.options)
  } else {
    hotAPI.reload("data-v-056b5e1a", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    urlHorario: function urlHorario(dni) {
      return '/profesor/' + dni + '/horario';
    },
    getFichajes: function getFichajes() {
      var _this = this;

      this.fichajes = {};
      this.msg = 'Esperando al servidor ...';
      __WEBPACK_IMPORTED_MODULE_0_axios___default.a.get('/api/faltaProfesor/dia=' + this.fecha.format('YYYY-MM-DD') + '?api_token=' + token).then(function (resp) {
        _this.msg = 'Datos recibidos';
        for (var i in resp.data.data) {
          var ficha = resp.data.data[i];
          if (_this.fichajes[ficha.idProfesor] == undefined) _this.fichajes[ficha.idProfesor] = ficha.entrada + '->' + ficha.salida;else _this.fichajes[ficha.idProfesor] += '<br>' + ficha.entrada + '->' + ficha.salida;
        }
        _this.msg = '';
      }).catch(function (resp) {
    ...
    getHorario: function getHorario() {
      ...
      this.horarios = {};
      __WEBPACK_IMPORTED_MODULE_0_axios___default.a.get('/api/horariosDia/' + this.fecha.format('YYYY-MM-DD') + '?api_token=' + token).then(function (resp) {
        return _this2.horarios = resp.data.data;
      }).catch(function (resp) {
        return console.error(resp);
      });
    },
    setDia: function setDia(cambio) {
      // Si es viernes el siguiente que sea el lunes
      if (cambio == 1 && this.fecha.day() == 5) cambio = 3;
      // Si es lunes el anterior que sea el viernes
      else if (cambio == -1 && this.fecha.day() == 1) cambio = -3;
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    clicked: function clicked(atras) {
      this.$emit('click', atras ? 0 - this.dias : this.dias);
    }
  }
});
...
var render = function() {
  ...
  return _c("div", [
    _c(
      "a",
      {
        staticClass: "pull-left prev-day",
        attrs: { href: "#" },
        on: {
      ...
      [_vm._v(_vm._s(_vm.titulo) + " anterior")]
    ),
    _vm._v(" "),
    _c(
      "a",
      {
        staticClass: "pull-right next-day",
        attrs: { href: "#" },
        on: {
          click: function($event) {
            $event.preventDefault()
      ...
      [_vm._v(_vm._s(_vm.titulo) + " siguiente")]
    )
  ])
}
var staticRenderFns = []
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-04181adb", module.exports)
  }
}
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue_datepicker__ = __webpack_require__(167);
...
var update = __webpack_require__(171)("7d981249", content, false, {});
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-660ede66", module.exports)
  }
}
...
var render = function() {
  ...
  return _c(
    "div",
    [
      _c("h3", [_vm._v(_vm._s(_vm.fechaEsp))]),
      _vm._v(" "),
      _c("control-nav", { attrs: { dias: "1" }, on: { click: _vm.setDia } }),
      _vm._v(" "),
      _c("div", { staticClass: "clearfix" }),
      _vm._v(" "),
      _vm.msg
        ? _c("p", { staticClass: "text-danger" }, [_vm._v(_vm._s(_vm.msg))])
        : _vm._e(),
      _vm._v(" "),
      _c("div", [
        _c(
          "table",
          { attrs: { id: "tabla-datos", border: "1" } },
          [
            _vm._m(0),
            _vm._v(" "),
            _vm._l(_vm.profes, function(profe) {
              return _c("tr", { key: profe.dni, attrs: { id: profe.dni } }, [
                _c("th", [_vm._v(_vm._s(profe.departamento))]),
                _vm._v(" "),
                _c("th", [
                  _vm._v(
                    _vm._s(profe.apellido1) +
                      " " +
                      _vm._s(profe.apellido2) +
                      ", " +
                      _vm._s(profe.nombre)
                  )
                ]),
                _vm._v(" "),
                _c("td", [
                  _c("span", { staticClass: "fichaje" }, [
                    _vm._v(_vm._s(_vm.horarios[profe.dni]))
                  ]),
                  _vm._v(" "),
                  _c(
                    "a",
                    {
                      staticClass: "btn-success btn btn-xs iconButton",
                      attrs: { href: _vm.urlHorario(profe.dni) }
                    },
                ...
                _c("td", [
                  _c("span", {
                    staticClass: "fichaje",
                    domProps: { innerHTML: _vm._s(_vm.fichajes[profe.dni]) }
                  })
                ])
              ])
            })
...
var staticRenderFns = [
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("tr", { attrs: { id: "profe-title" } }, [
      _c("th", [_vm._v("Dep")]),
      _c("th", [_vm._v("Profesor")]),
      _c("th", [_vm._v("Horario")]),
      _c("th", [_vm._v("Fichajes")])
    ])
  }
]
render._withStripped = true
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-056b5e1a", module.exports)
  }
}
...
Component.options.__file = "resources/assets/js/components/fichar/ControlSemanaView.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-13c5399c", Component.options)
  } else {
    hotAPI.reload("data-v-13c5399c", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    getFichajes: function getFichajes() {
      ...
      this.fichajes = {};
      this.msg = 'Esperando al servidor ...';
      __WEBPACK_IMPORTED_MODULE_0_axios___default.a.get('/api/faltaProfesor/horas/dia]' + this.sumaFecha(1) + '&dia[' + this.sumaFecha(5) + '?api_token=' + token).then(function (resp) {
        _this.fichajes = resp.data.message;
        _this.msg = '';
      }).catch(function (resp) {
        return _this.msg = 'ERROR del servidor ' + resp.status + '(' + resp.statusText + ')';
      });
    },
    setDia: function setDia(cambio) {
      this.fecha.add(cambio, 'days');
    ...
    sumaFecha: function sumaFecha(dias) {
      return this.fecha.clone().add(dias, 'days').format('YYYY-MM-DD');
    },
    muestraHoras: function muestraHoras(profe, masDias) {
      if (this.fichajes[profe] == undefined || this.fichajes[profe][this.sumaFecha(masDias)] == undefined) return '';
      return this.fichajes[profe][this.sumaFecha(masDias)].horas;
    },
    sumaHoras: function sumaHoras(profe) {
      var totHoras = 0;
      for (var ficha in this.fichajes[profe]) {
...
var render = function() {
  ...
  return _c(
    "div",
    [
      _c("control-nav", { attrs: { dias: "7" }, on: { click: _vm.setDia } }),
      _vm._v(" "),
      _c("div", { staticClass: "clearfix" }),
      _vm._v(" "),
      _vm.msg
      ...
      _c("div", [
        _c(
          ...
          [
            _c(
              "tr",
              { attrs: { id: "profe-title" } },
              [
                _c("th", [_vm._v("Dep")]),
                _c("th", [_vm._v("Profesor")]),
                _vm._l(5, function(n) {
                  return _c("th", [_vm._v(_vm._s(_vm.sumaFecha(n)))])
                }),
                _c("th", [_vm._v("Total")])
              ],
              2
            ...
            _vm._l(_vm.profes, function(profe) {
              return _c(
                ...
                { key: profe.dni },
                [
                  _c("th", [_vm._v(_vm._s(profe.depcurt))]),
                  _vm._v(" "),
                  _c("th", [
                    _c("a", { attrs: { href: _vm.urlHorario(profe.dni) } }, [
                      _vm._v(
                        _vm._s(profe.apellido1) +
                          " " +
                          _vm._s(profe.apellido2) +
                  ...
                  _vm._l(5, function(m) {
                    return _c("td", [
                      _vm._v(_vm._s(_vm.muestraHoras(profe.dni, m)))
                    ])
                  }),
                  _vm._v(" "),
                  _c("th", [_vm._v(_vm._s(_vm.sumaHoras(profe.dni)))])
                ],
                2
              )
            })
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-13c5399c", module.exports)
  }
}
...
Component.options.__file = "resources/assets/js/components/guardias/ControlGuardiaView.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-67316117", Component.options)
  } else {
    hotAPI.reload("data-v-67316117", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony default export */ __webpack_exports__["default"] = ({
  components: {
    'control-guardia-item': __webpack_require__(184),
    'control-nav': __webpack_require__(6)
  },
  ...
  methods: {
    borraFichajes: function borraFichajes() {
      for (var i in this.horas) {
        var hora = this.horas[i].codigo;
        this.fichajes[hora] = {};
        for (var j in this.dias) {
          var dia = this.dias[j];
          this.fichajes[hora][dia] = {};
        }
      }
    },
    getGuardias: function getGuardias() {
      var _this = this;

      this.borraFichajes();
      this.msg = 'Esperando al servidor ...';
      __WEBPACK_IMPORTED_MODULE_0_axios___default.a.get('/api/guardia/dia]' + this.sumaFecha(1) + '&dia[' + this.sumaFecha(5) + '?api_token=' + token).then(function (resp) {
        // Organizamos los datos en un objeto de horas->días->profes
        for (var i in resp.data.data) {
          var guardia = resp.data.data[i];
          // Para obtener el día restamos el de la guardia-1 a la fecha actual
          // y buscamos en el array de días la entrada de ese índice
          var dia = _this.dias[0 - _this.fecha.diff(guardia.dia, 'days')];
          _this.fichajes[guardia.hora][dia][guardia.idProfesor] = {
...
Component.options.__file = "resources/assets/js/components/guardias/ControlGuardiaItem.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-6619ba85", Component.options)
  } else {
    hotAPI.reload("data-v-6619ba85", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
      ...
      _vm.ficha
        ? [
            _c(
              ...
              {
                class:
                  "label label-" + (_vm.ficha.realizada ? "default" : "warning")
              },
              [_vm._t("default")],
              2
            ),
            _vm._v(" "),
            _vm.ficha.obs_personal
              ? _c("p", [_vm._v("Nota: " + _vm._s(_vm.ficha.obs_personal))])
              : _vm._e(),
            _vm._v(" "),
            _vm.ficha.observaciones
              ? _c("p", [_vm._v("OBS: " + _vm._s(_vm.ficha.observaciones))])
              : _vm._e()
          ]
        : [
            _c(
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-6619ba85", module.exports)
  }
}
  ...
  return _c(
    ...
    [
      ...
      _c("div", [
        _c(
          "table",
          { attrs: { id: "table-guardias", border: "1" } },
          [
            _c(
              "tr",
              { attrs: { id: "hora-title" } },
                ...
                [
                  _c("th", [
                    _vm._v(
                      _vm._s(hora.turno) +
                        " " +
                        _vm._s(hora.hora_ini) +
                        "-" +
                        _vm._s(hora.hora_fin)
                    )
                  ]),
                  _vm._v(" "),
                  _vm._l(_vm.dias, function(dia) {
                    return _c(
                      "td",
                      [
                        _vm.profesGuardia[hora.codigo] &&
                        _vm.profesGuardia[hora.codigo][dia]
                          ? _vm._l(
                              _vm.profesGuardia[hora.codigo][dia],
                              function(profesor) {
                                return _c(
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-67316117", module.exports)
  }
}
...
Component.options.__file = "resources/assets/js/components/reservas/ReservasView.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-4e32d36d", Component.options)
  } else {
    hotAPI.reload("data-v-4e32d36d", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
var ruta = '/api/reserva/';

var token = document.getElementById('_token').innerHTML;
var rolDirecc = 2;
var esDirecc = document.getElementById('rol').innerHTML % rolDirecc == 0;

var maxDiasReserva = 30;
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    getReservas: function getReservas() {
      ...
      __WEBPACK_IMPORTED_MODULE_0_axios___default.a.get(ruta + 'idEspacio=' + this.espacio + '&dia=' + this.fechaIni + '?api_token=' + token).then(function (resp) {
        return _this.reservas = resp.data.data;
      }).catch(function (resp) {
        return console.error(resp);
      });
    },
    idTd: function idTd(codigo) {
      return 'hora-' + codigo;
    },
    estaReservado: function estaReservado(hora) {
      return this.reservas[hora] != undefined;
    },
    fechaAct: function fechaAct() {
      var dias = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : maxDiasReserva;
...
Component.options.__file = "resources/assets/js/components/reservas/RecursosSelect.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-065dc7da", Component.options)
  } else {
    hotAPI.reload("data-v-065dc7da", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
var render = function() {
  ...
  return _c(
    ...
    [
      _c("option", { attrs: { value: "0" } }, [_vm._v("-- Selecciona --")]),
      _vm._v(" "),
      _vm._l(_vm.espacios, function(espacio) {
        return _c("option", { domProps: { value: espacio.aula } }, [
          _vm._v(_vm._s(espacio.descripcion))
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-065dc7da", module.exports)
  }
}
...
Component.options.__file = "resources/assets/js/components/reservas/HorasSelect.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-71a82bbc", Component.options)
  } else {
    hotAPI.reload("data-v-71a82bbc", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony default export */ __webpack_exports__["default"] = ({
  props: ['value', 'horas', 'title', 'iniVal'],
  methods: {
    updateValue: function updateValue(value) {
      this.$emit('input', value);
    }
      ...
      [
        ...
        _vm._l(_vm.horas, function(hora) {
          return _c(
            ...
            {
              key: hora.codigo,
              attrs: { disabled: hora.codigo < _vm.iniVal },
              domProps: { value: hora.codigo }
            },
            [
              _vm._v(
                "\n      " +
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-71a82bbc", module.exports)
  }
}
...
Component.options.__file = "resources/assets/js/components/reservas/HorasTable.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-6f3a503e", Component.options)
  } else {
    hotAPI.reload("data-v-6f3a503e", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
var render = function() {
  ...
  return _c(
    "div",
    { staticClass: "calendario", attrs: { id: "tableContainer" } },
    [
      _c("table", { staticClass: "table", attrs: { id: "horario" } }, [
        _c(
          "tbody",
          _vm._l(_vm.horas, function(hora) {
            return _c("tr", { key: hora.id }, [
              _c("th", [
                _vm._v(
                  _vm._s(hora.turno) +
                    " " +
              ...
              _vm._v(" "),
              _vm.estaReservado(hora.codigo)
                ? _c("td", { staticClass: "warning" }, [
                    _vm._v(
                      "\n          " +
                        _vm._s(_vm.reservas[hora.codigo].nomProfe) +
                        " (" +
                        _vm._s(_vm.reservas[hora.codigo].observaciones) +
                        ")\n          "
                    ),
                    _c("span", { staticClass: "hidden idProfe" }, [
                      _vm._v(_vm._s(_vm.reservas[hora.codigo].idProfesor))
                    ]),
                    _vm._v(" "),
                    _c("span", { staticClass: "hidden idReserva" }, [
                      _vm._v(_vm._s(_vm.reservas[hora.codigo].id))
                    ])
                  ])
                : _c("td", [_vm._v("Libre")])
            ])
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-6f3a503e", module.exports)
  }
}
...
var render = function() {
  ...
  return _c(
    ...
    [
      _c("br"),
      _c("h4", { staticClass: "centrado" }, [_vm._v("RESERVAR RECURSO2")]),
      _c("br"),
      _vm._v(" "),
      _c("recursos-select", {
        attrs: { espacios: _vm.espacios },
        on: { change: _vm.getReservas },
        model: {
          value: _vm.espacio,
          callback: function($$v) {
            _vm.espacio = $$v
      ...
      _vm.espacio != 0
        ? _c(
            ...
            [
              _c("br"),
              _c("label", { attrs: { for: "dia" } }, [_vm._v(" Día: ")]),
              _vm._v(" "),
              _c("fecha-picker", {
                attrs: { fechaIni: _vm.fechaAct(-1), fechaFin: _vm.fechaAct() },
                model: {
                  value: _vm.fechaIni,
                  callback: function($$v) {
                    _vm.fechaIni = $$v
              ...
              _vm._v(" "),
              _c("horas-table", {
                attrs: { horas: _vm.horas, reservas: _vm.reservas }
              }),
              _vm._v(" "),
              _c("horas-select", {
                attrs: {
              ...
              _vm.esDirecc
                ? _c(
                    ...
                    [
                      ...
                      _c("fecha-picker", {
                        attrs: {
                          fechaIni: _vm.FechaIni,
                          fechaFin: _vm.fechaAct(365)
                        },
                        model: {
                          value: _vm.fechaFin,
                          callback: function($$v) {
...
var staticRenderFns = [
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("label", { attrs: { for: "dia_fin" } }, [
      _vm._v(" Todos los "),
      _c("span", { attrs: { id: "nom_dia_fin" } }),
      _vm._v(" hasta el día: ")
    ])
  },
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { attrs: { id: "botones" } }, [
      _c("input", {
        staticClass: "btn btn-danger",
        attrs: { id: "reservar", type: "button", value: "Reservar" }
      }),
      _vm._v(" "),
      _c("input", {
        staticClass: "btn btn-success",
        attrs: { id: "liberar", type: "button", value: "Liberar" }
      })
    ])
  }
]
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-4e32d36d", module.exports)
  }
}
