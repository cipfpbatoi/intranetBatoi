...
<div style='width:106.6mm;height:68.98mm;float:left;margin:0.28cm;border:1pt #0068BA solid '>
    ...
    <div style='width:95%;border-left: 2px #0068BA solid' class="container col-lg-12" >
         <div style="float:left;width: 70%; margin-bottom: 0px;margin-left: 8pt; ">
            <p style="font-size: 10pt;text-align: left; margin-bottom: 0px;margin-top: 6px;"> {!! config('constants.contacto.web') !!}</p>
            <p style="font-size: 10pt;text-align: left; margin-bottom: 0px;margin-top: 1px;"> Tel: {!! config('constants.contacto.telefono') !!} Fax: {!! config('constants.contacto.fax') !!}</p>
            <p style="font-size: 10pt;text-align: left; margin-bottom: 0px;margin-top: 6px;"> {!! config('constants.contacto.direccion') !!}</p>
            <p style="font-size: 10pt;text-align: left; margin-bottom: 0px;margin-top: 1px;"> {!! config('constants.contacto.poblacion') !!} - C.P.:  {!! config('constants.contacto.postal') !!}</p>
            <p style="font-size: 10pt;text-align: left; margin-bottom: 0px;margin-top: 1px;"> {!! config('constants.contacto.provincia') !!} - Espanya</p>
        </div>
        <div style="float:right;width:20%;margin-top:5pt;margin-right:8pt;text-align: center">
