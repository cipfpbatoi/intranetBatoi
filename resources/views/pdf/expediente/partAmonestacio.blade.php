...
@section('content')
    ...
    <div class="page">
        ...
        <div class="container" style="width:95%;clear:right;text-align: justify">
            ...
            <p style="text-indent: 30px">D'acord amb el RRI del CIPFP BATOI (aprovat pel Consell Social el dia 20 d'abril de 2013). Per la present queda Vè. AMONESTAT per FALTA comesa en aquest Institut i que va ser la següent: </p>
