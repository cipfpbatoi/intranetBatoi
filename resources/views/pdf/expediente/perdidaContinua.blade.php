    ...
    @foreach ($todos as $elemento)
        <div class="page">
            ...
            <div class="container" style="width:95%;clear:right;text-align: justify">
                ...
                <p tyle="text-indent: 30px">L’aplicació del procés d’avaluació contínua de l’alumnat requerix la seua
                ...
                <p tyle="text-indent: 30px">La dita circumstància és acreditada i certificada pel cap d’estudis a partir
                    ...
                    familia” de la Conselleria d’Educació. Aquesta situació es comunicarà de forma fidedigna a:</p>
                <p>
            ...
            @if ($nac->age < 18 )
                <div class="container" style="width:90%;">
                    <p>En/Na __________________________________________________ com a pare, mare o tutor/a legal de
                        l’alumne/a (menor d’edat)
                        _________________________________________________ quede assabentat de la pèrdua de l’avaluació
                        contínua, amb data ___________.</p>
