        ...
        <div class='page'>
            ...
            <div class="container ">
                ...
                <div style="width:60%;float:right">
                    <table style="border: #000 thin solid;width: 80%; height: 90px;">
                        <tr>
                            <td style="padding:5px; vertical-align: top;font-size: 12px;">{{$datosInforme[$index]}}</td>
                        </tr>
                    </table>
                </div>
            </div>
            <div class="container">
                ...
                <div style="width:32%;float:right;text-align: right">{{strtoupper(config('contacto.poblacion'))}}
                    a {{fechaString()}}<br/><br/>
                    @if ($profesor->sexo == 'H')
