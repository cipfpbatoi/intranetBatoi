...
<div class="container" >
    <br/>
    <p>Em dirigisc a vostes com a tutor/a del seu fill/filla amb la finalitat de convidar-los a la reunió que tindrà lloc el dia <strong>{{$datosInforme->dia}}</strong> a les <strong>{{$datosInforme->hora}}</strong>
...
<div class="container">
    <br />
    Agraïnt-los la seua assitència i col.laboració per endavant. Una Salutació
</div>
