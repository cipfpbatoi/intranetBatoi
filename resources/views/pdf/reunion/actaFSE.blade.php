...
<div class="container" >
    ...
    <table class="table table-bordered" style="width: 1000px">
        ...
        <tr><td style="font-size:20px;text-align: left">Nom del cicle </td><td style="font-size:20px;text-align: left" ><strong>{{$grupo->Ciclo->vliteral}}</strong></td><td style="font-size:20px;text-align: left">Grau: <strong>{{$grupo->Ciclo->tipo==1?'Mitjà':($grupo->Ciclo->tipo==2?'Superior':'Bàsic')}}</strong> </td></tr>
        <tr><td style="font-size:20px;text-align: left">Curs/Grup</td><td  style="font-size:20px;text-align: left"><strong>{{$grupo->nombre}}</strong></td><td  style="font-size:20px;text-align: left">Data:<strong> {{Hoy('d/m/Y')}} </strong></td></tr>
        <tr><td style="font-size:20px;text-align: left">Tutor/a</td><td  style="font-size:20px;text-align: left"><strong>{{$grupo->Tutor->FullName}}</strong></td><td  style="font-size:20px;text-align: left">Signatura:<br/><br/><br/><br/></td></tr>
    </table>   
