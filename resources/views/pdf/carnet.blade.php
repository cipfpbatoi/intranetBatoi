...
@section('content')
    @foreach ($todos as $elemento)
        ...
        @endphp
    <div class="page">
        <div class="container col-lg-12" style="margin-bottom: -5px;" >
            <div style="float:left;width:26%;margin-left:10px"><img src="{{public_path('/img/pdf/logo.png')}}" width="70px" height="70px" alt="Logo Insti"/></div>
            <div style="float:left;width:26%;margin-left:15px"><img style="margin: auto" src="{{public_path('img/pdf/conselleria.png')}} " width="125px" height="65px" alt="Logo Conselleria"/></div>
