...
@section('content')
    ...
    <div class="page">
        <div class="container col-lg-12" style="margin-bottom: 0px;" >
            ...
            <div style="float:left;width:26%;margin-left:15px"><img style="margin: auto" src="{{public_path('img/pdf/conselleria.png')}} " width="100px" height="50px" alt="Logo Conselleria"/></div>
