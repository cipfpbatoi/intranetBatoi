...
@section('content')
    ...
    <table border="1" style="margin-bottom: 10px">
        ...
        <tr>
            <td style="text-align:left;width:13.283cm;padding-left: 5px; "><strong>Revisió
                    actual:</strong><span> 8</span></td>
            <td style="text-align:left;width:10.523cm;padding-left: 5px; "><strong>Data revisió actual:</strong><span> 13-04-2016</span>
            </td>
        </tr>
        <tr>
            <td style="text-align:left;padding-left: 5px;" colspan="2"><strong>Objectiu:</strong><span> Comprovar la recepció del certificat de pràctiques per part de l'alumne</span>
            </td>
        </tr>
    </table>
    <div style="border: black solid thin;padding:5px">
        ...
        <ul style="list-style-type: square ; font-size: 13px">
            <li>Seguiment formació en Empresa. Explicar Annex V i com emplenar-lo al SAÓ (La correcta complimentació
                servirà de memòria final de l'alumne en l'FCT)
            </li>
            <li>Periodicitat de les visites d'alumnes a professors-tutors. PR04-02</li>
            <li>S'informa de com utilitzar el registre de queixes i suggerències (PG06-01), disponible al web del
                centre. Zona FCT.
            </li>
        ...
        <table border='1' style="width:350px;height:100px;float:left;margin-bottom: 20px">
            <tr>
                <td style='text-align: left; vertical-align: top '><strong>Observacions:</strong></td>
            </tr>
        </table>
        ...
        <p style='font-size: 8px'>Pref* :S'han tingut en compte les preferències i interessos particulars dels alumnes
            per assignar l'Empresa.</p>
