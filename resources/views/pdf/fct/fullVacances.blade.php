...
@section('content')
    <div style="font-size:large;line-height: 2em">
        ...
        <div class="container col-lg-12" style="width:90%;">
            ...
            <p style="text-indent: 50px">En/Na: {{ authUser()->fullName }} tutor de FCT del
                grup:<strong> {{ $grupo->nombre  }}</strong>
        ...
        <div class="container" style="width:95%">
            <p style="text-indent: 30px;text-align: justify">
                Segon Ordre 77/2010 en el seu article 14.3, la rel·lació de l'alumnat que realitzarà les pràcticas
                formatives
        ...
        <hr/>
        <div class="container" style="width:95%">
            <p style="text-indent: 30px;text-align: justify">Durant este periode els seus centres de práctiques romanen
                oberts amb el mateix servei,
            ...
            <p style="text-indent: 30px;text-align: justify">Durant este periode l'alumnat i el centre podran contactar
                de forma telefònica o via e-mail amb el seu tutor/a per resoldre qualsevol incidència que poguera
                sorgir.</p>
