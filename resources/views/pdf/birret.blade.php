...
@section('content')
    ...
    <div class="container col-lg-12" >
        <table class="table table-bordered" >
            <thead>
            <tr>
                <th>FUNCIONARI/A:</th><th>DNI</th><th>Dia</th><th>Hora</th>
                <th>Grup</th><th>En centre</th><th>Justificació</th>
            </tr>
            </thead>
            <tbody>
            @foreach ($todos as $elemento)
                <tr>
                    <td>
                        {!! $elemento->Profesor->apellido1 !!}
                        {!! $elemento->Profesor->apellido2 !!}
                        {!! $elemento->Profesor->nombre !!}
                    </td>
