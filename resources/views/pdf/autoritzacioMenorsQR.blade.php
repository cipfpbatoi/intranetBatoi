    ...
    @foreach ($todos as $elemento)
        <div class='page'>
            ...
            <div class="container col-lg-12">
                <p><strong>Asistencia a actividad extraescolar. Asistència a activitat extraescolar.
                        Grup {!! $elemento->Grupo->first()->nombre !!} </strong></p>
                ...
                <p>Esta activitat es desenvoluparà des de {{ $datosInforme->desde }} fins {{ $datosInforme->hasta }}
                    .</p>
            </div>
            <br/><br/><br/><br/>
