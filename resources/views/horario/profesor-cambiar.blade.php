...
@section('content')
	...
	<p>Sobre tu horario original cambia las horas arrástrandolas a donde desees
		y cuando lo tengas pulsa el botón de 'Guardar cambios'.</p>
	<p>Cuando lo haya aprobado jefatura te aparecerá tu horario cambiado.</p>
	<p>En el campo observaciones debes poner el nº de horas que liberas y
