                ...
                <tr>
                    ...
                    <td>
                        ...
                        @if ($isDireccion && $puedeAceptar)
                            ...
                            <a class="btn btn-danger" href="{{ route('horario.propuesta.rebutjar', ['dni' => $proposta['dni'], 'id' => $proposta['id']]) }}" data-dni="{{ $proposta['dni'] }}" data-id="{{ $proposta['id'] }}" onclick="return rebutjarProposta(this.dataset.dni, this.dataset.id)" title="Rebutjar" aria-label="Rebutjar">
