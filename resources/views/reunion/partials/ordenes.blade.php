<div class="panel">
    <a class="panel-heading" role="tab" id="headingTwo" data-toggle="collapse" data-parent="#accordion" href="#collapseTwo" aria-expanded="true" aria-controls="collapseTwo">
        <h4 class="panel-title"><i class="fa fa-bars"></i> {{trans("models.Reunion.ordenes")}}</h4>
    </a>
    <div id="collapseTwo" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingTwo">
        <div class="panel-body">
            <table class="table table-striped table-condensed" name='ordenreunion'>
                <tr><th style="width: 5%">{{trans("validation.attributes.orden")}}</th><th style="width: 40%">{{trans("validation.attributes.descripcion")}}</th> <th style="width: 40%">{{trans("validation.attributes.resumen")}}</th><th style="width: 10%">{{trans("validation.attributes.operaciones")}}</th></tr>
                ...
                <form method="POST" class="agua" action="/reunion/{!!$elemento->id!!}/nuevoOrden">
                    ...
                    <tr>
                        <td><input type='text' name='orden' class="form-control"></td>
                        <td><input type='text' name='descripcion' class="form-control"></td>
                        <td><textarea  rows="1"  name='resumen'class="form-control" ></textarea></td>
                        <td><input id="submit" class="boton" type="submit" value="{{trans("messages.generic.anadir")}} {{trans("models.modelos.OrdenReunion")}} "></td>
                    </tr>
                </form>
            </table>
        </div>
