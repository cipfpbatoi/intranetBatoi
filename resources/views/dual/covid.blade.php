...
@section('content')
    ...
    <p style="font-size: 20px;text-align: center;line-height: 1.5em;">
        <strong>Conformitat de l’alumnat per a iniciar la formació en l’empresa corresponent al sistema de Formació Professional Dual en l’actual situació d’alerta sanitària generada pel COVID-19</strong>
    </p>
