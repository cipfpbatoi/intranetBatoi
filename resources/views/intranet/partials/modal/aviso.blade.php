  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">{{trans('messages.buttons.avisar')}} {{trans('models.modelos.'.$panel->getModel()) }}</h4>
      </div>
      ...
      <div class="modal-footer">
		<button type="submit" form="formAviso" class="btn btn-primary">{{trans('messages.buttons.avisar')}}</button>
