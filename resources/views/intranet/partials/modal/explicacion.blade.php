  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">@lang("messages.buttons.refuse") {{trans('models.modelos.'.$panel->getModel()) }}</h4>
      </div>
      ...
      <div class="modal-footer">
		<button type="submit" form="formExplicacion" class="btn btn-primary">@lang("messages.buttons.refuse")</button>
