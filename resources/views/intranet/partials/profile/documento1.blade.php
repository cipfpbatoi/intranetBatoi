                ...
                <a href="{{$edit}}" class="pull-left border-aero profile_thumb">
                    @else
                        ...
                        <div class="media-body">
                            <a href="{{$enlace}}" class="title"><em class="fa fa-calendar"></em> {{$elemento->curso}}
                                <br/> {{day($elemento->created_at)}} {{month($elemento->created_at)}}</a>
                            <p>
                                <a href="{{$enlace}}">
                                    {{substr($elemento->descripcion,0,60)}}
                                    @if (strlen($elemento->descripcion)>60)
                                        ...
                                    @endif
                                    @if (strlen($elemento->descripcion)<34)
                                        <br/><br/>
                                    @endif
                                </a>
                            </p>
