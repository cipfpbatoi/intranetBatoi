...
<div class="gruposContainer col-lg-8 col-md-6 col-sm-10 col-xs-10 col-lg-offset-2 col-md-offset-2 col-sm-offset-1">
    <h4 class="centrado" >{{trans("models.Actividad.grupos")}}</h4><br>
    <table class="table table-striped table-condensed">
        <tr><th>{{trans("validation.attributes.codigo")}}</th> <th>{{trans("validation.attributes.name")}}</th> <th>{{trans("validation.attributes.operaciones")}}</th></tr>
...
<div class="gruposContainer col-lg-8 col-md-6 col-sm-10 col-xs-10 col-lg-offset-2 col-md-offset-2 col-sm-offset-1">
    <form method="POST" class="agua" action="/actividad/{!!$Actividad->id!!}/nuevoGrupo">
        ...
        <input id="submit" class="boton" type="submit" value="{{trans("messages.generic.anadir")}} {{trans("models.modelos.Grupo")}} ">
     </form>
</div>
