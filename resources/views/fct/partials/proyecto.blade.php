@php $proyecto = \Intranet\Entities\Documento::where('propietario',$elemento->Alumno->FullName)->first() @endphp
@if ($proyecto)
        ...
        <li>
            ...
            <div class="message_wrapper" style="width:50%">
                <h4>
                    ...
                    <span class='info' style="font-weight: bold">Qualificació: {!! $elemento->calProyecto !!} </span>
