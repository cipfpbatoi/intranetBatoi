...
<div class='x-content'>
    ...
    {{ csrf_field() }}
    <div class="form-group item"><label class="control-label col-md-3 col-sm-3 col-xs-12">Desde data:</label><div class="col-md-6 col-sm-6 col-xs-12"><input type='text' class="date form-control" id='desde' name='desde'/></div></div>
