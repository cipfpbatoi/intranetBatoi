...
- [x] 2.3.d Inici migració a `Policies`: `EmpresaPolicy`, `FctPolicy` i `ColaboracionPolicy` aplicades en controladors i registrades en `AuthServiceProvider` (+ tests unitaris de policy)
