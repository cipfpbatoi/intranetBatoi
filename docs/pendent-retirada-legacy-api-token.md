...
2. **Rutes protegides en mode mixt / migració parcial**  
   ...
   - `/api/faltaProfesor/*` + `faltaProfesor/horas/*` -> `auth:sanctum` (migrat 2026-03-02)
   - `/api/guardia/*` + `guardia/range` -> `auth:sanctum` (migrat 2026-03-02)
   - `/api/reserva/*` -> `auth:sanctum` (migrat 2026-03-02, excepte flux especial `/api/aula`)
   - `/api/activity/*` + `activity/*/move/*` -> `auth:sanctum` (migrat 2026-03-02)
   - `/api/grupo/list/*` -> `auth:sanctum` (migrat 2026-03-02)
   - `/api/tiporeunion/*` -> `auth:sanctum` (migrat 2026-03-02)
   - `/api/alumnogrupo/*` + `alumnoGrupoModulo/*` -> `auth:sanctum` (migrat 2026-03-03)
   - `/api/horario/*` + `horario/*/guardia` + `horariosDia/*` + `horarioChange/*` -> `auth:sanctum` (migrat 2026-03-03)
   - `/api/alumnofct/*` + `alumnofct/*/grupo` + `alumnofct/*/dual` -> `auth:sanctum` (migrat 2026-03-03)
   - `/api/fct/*/alFct` (GET/POST) -> `auth:sanctum` (migrat 2026-03-03)
   - `/api/materialbaja/*` -> `auth:sanctum` (migrat 2026-03-03)
   ...
   - `/api/departamento/*` -> `auth:sanctum` (migrat 2026-03-03)
   - `/api/centro/*` -> `auth:sanctum` (migrat 2026-03-03)
   - `/api/grupotrabajo/*` -> `auth:sanctum` (migrat 2026-03-03)
   - `/api/Empresa/*` -> `auth:sanctum` (migrat 2026-03-03)
   - `/api/ordentrabajo/*` -> `auth:sanctum` (migrat 2026-03-03)
   - `/api/incidencia/*` -> `auth:sanctum` (migrat 2026-03-03)
   - `/api/tipoincidencia/*` -> `auth:sanctum` (migrat 2026-03-03)
   - `/api/espacio/*` -> `auth:sanctum` (migrat 2026-03-03)
   - `/api/hora/*` -> `auth:sanctum` (migrat 2026-03-03)
   - `/api/notification/*` -> `auth:sanctum` (migrat 2026-03-03)
   - `/api/modulo/*` -> `auth:sanctum` (migrat 2026-03-03)
   - `/api/reunion/*` + `/api/reunion/*/alumno/*` -> `auth:sanctum` (migrat 2026-03-03)
   - `/api/ordenreunion/*` -> `auth:sanctum` (migrat 2026-03-03)
   - `/api/programacion/*` -> `auth:sanctum` (migrat 2026-03-03)
   - `/api/documento/*` -> `auth:sanctum` (migrat 2026-03-03)
   - `/api/modulo_ciclo/*` -> `auth:sanctum` (migrat 2026-03-03)
   - `/api/resultado/*` -> `auth:sanctum` (migrat 2026-03-03)
   - `/api/instructor/*`, `/api/ipguardia/*`, `/api/setting/*`, `/api/ppoll/*` -> `auth:sanctum` (migrat 2026-03-03)
