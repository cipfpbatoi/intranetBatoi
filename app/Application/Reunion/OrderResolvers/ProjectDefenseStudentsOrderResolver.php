...
/**
 * Genera un punt per cada alumne amb projecte pendent de defensa.
 */
class ProjectDefenseStudentsOrderResolver implements ReunionOrderResolver
{
    public const KEY = 'project_defense_students';
    ...
    {
        return $this->students->projectStudents((string) $reunion->idProfesor)
