...
Route::get('/incidencia/{incidencia}/orden', ['as' => 'incidencia.orden', 'uses' => 'IncidenciaController@orden']);
Route::get('/incidencia/{incidencia}/remove', ['as' => 'incidencia.remove', 'uses' => 'IncidenciaController@remove']);
...
Route::get('/ordentrabajo/{orden}/anexo', ['as' => 'orden.anexo', 'uses' => 'IncidenciaController@anexo']);
