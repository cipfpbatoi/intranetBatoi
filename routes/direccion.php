...
Route::put('/comision/{comision}/edit', ['as' => 'comision.direccion.update', 'uses' => 'ComisionController@updateFromDireccion']);
Route::get('/comision/{comision}/gestor', ['as' => 'comision.direccion.gestor', 'uses' => 'ComisionController@gestor']);
