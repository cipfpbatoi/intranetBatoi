...
return [
    ...
    'estadoProjecte' => ['No comunicat', 'En revisió', 'Acceptat'],
    'numeracion' => ['--','01','02','03','04','05','06','07','08','09','10','11','12','13','14','15',
        '16','18','19','20',24=>'20',25=>'21',26=>'22',27=>'23',28=>'24',29=>'25',40=>'26',41=>'27',
        42=>'28',43=>'29',44=>'30',45=>'31',46=>'32',47=>'33',48=>'34',49=>'35',
    ...
    'motivoAusencia' => [
        ...
        'ASISTENCIA MÉDICO, EDUCATIVO Y ASISTENCIAL',
        'ASISTENCIA PRUEBAS SELECTIVAS Y EXÁMENES',
        'CELEBRACIÓN DE MATRIMONIO O UNIÓN DE HECHO',
        'COMISION DE SERVICIO',
        'CONTRATO DE RELEVO. RELEVISTA',
        'DEBER INEXCUSABLE',
        'ENFERMEDAD COMÚN (SIN BAJA MÉDICA)',
        'ENFERMEDAD GRAVE O FALLECIMIENTO DEL CÓNYUGE O PAREJA DE HECHO O FAMILIAR DE PRIMER O SEGUNDO GRADO',
        'FUNCIONES REPRESENTATIVAS Y FORMACIÓN',
        'INCAPACIDAD LABORAL TRANSITORIA (BAJA MÉDICA)',
        "INTERRUPCIÓN DEL EMBARAZO",
        'JUBILACIÓN PARCIAL',
        'LACTANCIA',
        'LACTANCIA/ADOPCIÓN',
        'LIC. SIN RETRIBUCIÓN',
        'LICENCIA PARA ASISTENCIA A CURSOS DE PERFECCIONAMIENTO PROFESIONAL (NO RETRIBUIDAS)',
        'LICENCIA PARA LA ASISTENCIA A CONFERENCIAS, SEMINARIOS, CONGRESOS Y JORNADAS (RETRIBUIDAS)',
        'LICENCIA POR BECAS DE ESTUDIO O INVESTIGACIÓN (NO RETRIBUIDAS)',
        'LICENCIA POR ENFERMEDAD DE FAMILIARES (NO RETRIBUIDAS)',
        'LICENCIA POR ESTUDIOS (RETRIBUIDAS)',
        'LICENCIA POR INTERÉS PARTICULAR (NO RETRIBUIDAS)',
        'LICENCIA POR RIESGO EN EL EMBARAZO',
        ...
        'PERMÍS RETRIBUÏT PER ASSUMPTES PARTICULARS'
        ],
    'motivoAusenciaOld' => [
        'Baixa mèdica',
